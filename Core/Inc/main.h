...
#define DISPL_RESET_Pin GPIO_PIN_0
#define DISPL_RESET_GPIO_Port GPIOB
...
#define SPI_IO0_Pin GPIO_PIN_9
#define SPI_IO0_GPIO_Port GPIOC
...
#define SPI_IO1_GPIO_Port GPIOC
